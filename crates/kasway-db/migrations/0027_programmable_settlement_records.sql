...
CREATE TABLE programmable_settlement_templates (
  ...
  kill_switch_enabled BIGINT NOT NULL DEFAULT 1,
...
CREATE TABLE programmable_settlement_approvals (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  template_record_id BIGINT NOT NULL REFERENCES programmable_settlement_templates(id) ON DELETE CASCADE,
